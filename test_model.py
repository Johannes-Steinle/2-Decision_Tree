...
class TestMLModel(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.X_train = train_df.drop('not.fully.paid', axis=1)
        cls.y_train = train_df['not.fully.paid']
        cls.X_test = test_df.drop('not.fully.paid', axis=1)
        cls.y_test = test_df['not.fully.paid']
